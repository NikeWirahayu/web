    ...
    <div class="section-content bg-white p-30">
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- Appointment Form -->
          <form id="popup_appointment_form" name="popup_appointment_form" class="" method="post" action="http://thememascot.net/demo/personal/j/learnpro/v3.0/demo/ajax-load/includes/appointment.php">
            <div class="row">
              <div class="col-sm-12">
