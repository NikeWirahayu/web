            ...
            <div class="row">
              <div class="course-list-block clearfix mb-30">
                <div class="col-sm-6 col-md-4">
                  <div class="thumb"> <img alt="featured project" src="images/course/course-list1.jpg" class="img-fullwidth mt-5"></div>
                </div>
                <div class="col-sm-6 col-md-8">
                  <h4 class="line-bottom mt-0 mb-15 mt-sm-20">Accounting Technologies</h4>
                  <ul class="mb-10">
                    <li><h4 class="mt-0 mb-5">Price :<span class="text-theme-colored2"> $125</span></h4></li>
              ...
              <div class="course-list-block clearfix mb-30">
                <div class="col-sm-6 col-md-4">
                  <div class="thumb"> <img alt="featured project" src="images/course/course-list2.jpg" class="img-fullwidth mt-5"></div>
                </div>
                <div class="col-sm-6 col-md-8">
                  <h4 class="line-bottom mt-0 mb-15 mt-sm-20">Accounting Technologies</h4>
                  <ul class="mb-10">
              ...
              <div class="course-list-block clearfix mb-30">
                <div class="col-sm-6 col-md-4">
                  <div class="thumb"> <img alt="featured project" src="images/course/course-list3.jpg" class="img-fullwidth mt-5"></div>
                </div>
                <div class="col-sm-6 col-md-8">
                  <h4 class="line-bottom mt-0 mb-15 mt-sm-20">Accounting Technologies</h4>
                  <ul class="mb-10">
              ...
              <div class="course-list-block clearfix mb-30">
                <div class="col-sm-6 col-md-4">
                  <div class="thumb"> <img alt="featured project" src="images/course/course-list4.jpg" class="img-fullwidth mt-5"></div>
                </div>
                <div class="col-sm-6 col-md-8">
                  <h4 class="line-bottom mt-0 mb-15 mt-sm-20">Accounting Technologies</h4>
                  <ul class="mb-10">
