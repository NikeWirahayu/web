  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="<?=base_url('public/images/bg/bg4c.jpg');?>">
      <div class="container pt-120 pb-60">
        <!-- Section Content -->
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-white text-uppercase ">Agenda Kesiswaan <span class="text-theme-colored2"></span></h2>
              ...
              <div class="row">
                ...
                <div class="col-sm-4 pl-0 pl-sm-15">
                  <div class="event-details p-15 mt-20">
                    ...
                    <a href="<?php echo base_url('smkbmpare/detailAgenda'); ?>" class="btn btn-flat btn-dark btn-theme-colored btn-sm">Details <i class="fa fa-angle-double-right"></i></a>
                  </div>
                </div>
                <div class="col-sm-4">
