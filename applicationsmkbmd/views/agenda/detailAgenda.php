  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="<?php echo base_url('public/images/bg/bg1.jpg'); ?>">
      <div class="container pt-120 pb-60">
        <!-- Section Content -->
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Detail Agenda</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="#">Home</a></li>
                <li><a href="<?php echo base_url('smkbmpare/agenda') ?>">Agenda</a></li>
            ...
            <div class="blog-posts single-post">
              <article class="post clearfix mb-0">
                <div class="entry-header">
                  <div class="post-thumb thumb"> <img src="<?php echo base_url('public/images/bg/bg2.jpg'); ?>" alt="" class="img-responsive img-fullwidth"> </div>
                </div>
