...
<head>
    ...
    <title>Login - SMK Bhakti Mulia</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Login SMK Bhakti Mulia Pare</h3>
                    </div> 
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url('authen/proseslogin') ?>" method="post">
                            <fieldset>
