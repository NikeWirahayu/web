    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="<?=base_url('public/images/bg/bg1.jpg');?>">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-white text-uppercase ">Administrasi Perkantoran</h2>
          ...
          <div class="col-md-12">
            <div class="single-service">
              ...
              <div class="text-center">
                <h3 class="text-uppercase mt-30 mb-10">Administrasi Perkantoran</h3>
                ...
                <ul class="list-inline mb-15">
                  <li>
                    ...
                    <div class="pull-right ml-5">
                      <span>Jurusan</span>
                      <h5 class="mt-0">Administrasi Perkantoran</h5>
                    </div>
                  </li>
                  <li>
              ...
              <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade" id="tab2">
                  <h4 class="line-bottom-theme-colored-2 mb-15">Produk Administrasi Perkantoran</h4>
